...
async function uploadImage(seed, label) {
  const localFile = path.join(PUBLIC_IMAGES_DIR, `${seed}.jpg`);
  if (fs.existsSync(localFile)) {
    try {
      const buffer = fs.readFileSync(localFile);
      const asset = await client.assets.upload("image", buffer, { filename: `${seed}.jpg` });
      process.stdout.write(`  ✓ ${label} (from public/images)\n`);
      return asset;
    } catch (err) {
...
// Old seed assets (picsum placeholders) that are being replaced — removed so
// the dataset only keeps the real website images.
const OLD_SEED_FILENAMES = [
  "hunza-valley.jpg", "skardu-landscape.jpg", "fairy-meadows.jpg", "swat-valley.jpg",
  "naran-kaghan.jpg", "lahore-city.jpg", "murree-hills.jpg", "concordia-k2.jpg",
  "hunza-luxury.jpg", "skardu-adventure.jpg", "fairy-meadows-trek.jpg", "swat-family.jpg",
  "naran-saif.jpg", "lahore-heritage.jpg", "k2-basecamp.jpg", "murree-honeymoon.jpg",
  "attabad-lake.jpg", "deosai-camp.jpg", "nanga-parbat-meadow.jpg", "malam-jabba.jpg",
  "saif-ul-malook.jpg", "badshahi-mosque.jpg", "concordia-pano.jpg", "murree-cable-car.jpg",
  "hunza-seasons.jpg", "packing-trek.jpg", "hidden-lakes.jpg", "responsible-tourism.jpg",
];

async function removeOldSeedImages() {
  let assets = [];
  try {
    assets = await client.fetch(
      '*[_type == "sanity.imageAsset" && originalFilename in $names]',
      { names: OLD_SEED_FILENAMES }
    );
  } catch {
    assets = [];
  }
  for (const asset of assets) {
    try {
      ...
      process.stdout.write(`  ✗ removed old asset ${asset.originalFilename}\n`);
    } catch (err) {
      process.stdout.write(`  ⚠ could not remove ${asset.originalFilename} — ${err.message}\n`);
    }
  }
}
...
const galleryImages = [
  { _type: "galleryImage", _id: "gal-01", caption: "Golden hour at Attabad Lake", location: "Hunza", likes: 482, order: 1, imageSeed: "baig_tours_gallery_img" },
  { _type: "galleryImage", _id: "gal-02", caption: "Camp night in Deosai", location: "Skardu", likes: 391, order: 2, imageSeed: "baig_tours_gallery_img2" },
  { _type: "galleryImage", _id: "gal-03", caption: "Nanga Parbat from Fairy Meadows", location: "Fairy Meadows", likes: 567, order: 3, imageSeed: "baig_tours_gallery_img3" },
  { _type: "galleryImage", _id: "gal-04", caption: "Chairlift over Malam Jabba", location: "Swat", likes: 274, order: 4, imageSeed: "baig_tours_gallery_img4" },
  { _type: "galleryImage", _id: "gal-05", caption: "Saif-ul-Malook at dawn", location: "Naran", likes: 618, order: 5, imageSeed: "baig_tours_gallery_img5" },
  { _type: "galleryImage", _id: "gal-06", caption: "Badshahi Mosque courtyard", location: "Lahore", likes: 340, order: 6, imageSeed: "baig_tours_gallery_img6" },
  { _type: "galleryImage", _id: "gal-07", caption: "Concordia panorama", location: "K2 Base Camp", likes: 705, order: 7, imageSeed: "baig_tours_gallery_img7" },
  { _type: "galleryImage", _id: "gal-08", caption: "Cable car above the pines", location: "Murree", likes: 219, order: 8, imageSeed: "baig_tours_gallery_img8" },
  { _type: "galleryImage", _id: "gal-09", caption: "Snow-capped peaks at sunrise", location: "Gilgit-Baltistan", likes: 512, order: 9, imageSeed: "baig_tours_gallery_img9" },
  { _type: "galleryImage", _id: "gal-10", caption: "Valley road through the north", location: "Northern Pakistan", likes: 328, order: 10, imageSeed: "baig_tours_gallery10" },
  { _type: "galleryImage", _id: "gal-11", caption: "Trekking through the highlands", location: "Karakoram", likes: 445, order: 11, imageSeed: "baig_tours_gallery_img11" },
  { _type: "galleryImage", _id: "gal-12", caption: "Crystal clear alpine waters", location: "Skardu", likes: 389, order: 12, imageSeed: "baig_tours_gallery_12" },
  { _type: "galleryImage", _id: "gal-13", caption: "Local village life in the mountains", location: "Hunza", likes: 276, order: 13, imageSeed: "baig_tours_gallery_img13" },
  { _type: "galleryImage", _id: "gal-14", caption: "Majestic mountain pass", location: "Deosai", likes: 503, order: 14, imageSeed: "baig_tours_gallery_img14" },
  { _type: "galleryImage", _id: "gal-15", caption: "Sunset over the Karakoram", location: "Gilgit-Baltistan", likes: 617, order: 15, imageSeed: "baig_tours_gallery_img15" },
];
...
async function main() {
  ...
  // Step 5: Remove old placeholder assets replaced by the real website images
  process.stdout.write("\n── Removing old placeholder images ──\n\n");
  await removeOldSeedImages();
